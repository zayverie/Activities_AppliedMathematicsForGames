...
public class W2_ScreenBoundary : MonoBehaviour
{
    ...
    public void screenBoundary(Transform objectTransform){

        //Convert the player's current 3D world position into a 0-to-1 screen position
        Vector3 viewportPos = cam.WorldToViewportPoint(objectTransform.position);
        ...
        objectTransform.position = cam.ViewportToWorldPoint(viewportPos);
    }
}
